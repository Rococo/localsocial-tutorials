...
public class About extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNotice.append(Html.fromHtml("<big>Simple v 1.0 is powered by LocalSocial.</big>"));
        mNotice.append("\n");
        mNotice.append("\n");
        ...
        mNotice.append("\n");
        mNotice.append("\n");
        mNotice.append(Html.fromHtml("<big>if you use other Bluetooth services you may need to end them this application to work properly.</big>"));
        mNotice.append("\n");
        mNotice.append("\n");
